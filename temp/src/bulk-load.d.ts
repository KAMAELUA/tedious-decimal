...
declare class BulkLoad extends EventEmitter {
     ...
     * @private
     */
    constructor(table: string, connectionOptions: InternalConnectionOptions, { checkConstraints, fireTriggers, keepNulls, lockTable, order, }: Options, callback: Callback);
    /**
